...
function ProductList() {
    ...
    const itemIconCounter = useSelector((state) => state.cart.items)
   ...
   const handleCartClick = (e) => {
    ...
    const isItemInCart = (item) => {
        return itemIconCounter.some(el => el.name === item.name)
    }

    const getTotalItems = () => {
        return itemIconCounter.reduce((acc, curr) => acc + curr.quantity, 0);
    }
        ...
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div style={{position: 'relative'}}> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    <i className='child-numb'>{getTotalItems()}</i>
                ...
                <div key={index}>
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button className="product-button"  style={{backgroundColor: (isItemInCart(plant) ? '#EBEBE4': '#e74c3c')}} disabled={isItemInCart(plant)}  onClick={() => handleAddToCart(plant)}>Add to Cart</button>
                        </div>
                        ))}
                    </div>
                </div>
